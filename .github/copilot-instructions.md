...
<!-- Updated: 2026-05-18T17:17:08.306Z -->
...
```
pkg/aptcache/aptcache_test.go                 +TestMultiArchClassification  ~TestLookup_AptIndex  ~TestPackageInfo_MultiArchForeign
pkg/builders/common/interface_test.go         ~TestIsHostOnlyPackage  ~TestQualifyDepsForTargetArch
pkg/constants/formats_test.go                 ~TestGetInstallArgs
pkg/project/skip_deps_test.go                 +TestSkipDeps  +TestYapJSONFields
pkg/builders/common/cross.go                  +isPerlModule  ~isHostOnlyPackage  ~partitionArchAllDeps  ~partitionArchAllDepsForExtract
pkg/builders/common/interface.go              ~getUpdateCommand
pkg/constants/formats.go                      ~GetInstallArgs
pkg/platform/system.go                        ~GOSetup
cmd/yap/command/build.go                      ~InitializeBuildDescriptions  ~init
.github/copilot-instructions.md               +TestVersionCommand  +TestVersionCommandDefinition  +main  +printVersion
```
