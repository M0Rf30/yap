...
<!-- Updated: 2026-05-14T11:18:17.402Z -->
...
pkg/builders/common/interface_test.go         +TestQualifyDepsForTargetArch  +level  +logic  ~TestBuildPackageName
pkg/builders/common/toolchains_methods_test.go ~TestI686PackageNaming
...
pkg/builders/common/interface.go              +partitionArchAllDeps  +qualifyDepsForTargetArch  +and  ~getExtension
...
.github/copilot-instructions.md               +initCommandDescriptions  +validateCompression  +resolveSigning  +logStructuredError
```
