...
<!-- Updated: 2026-05-23T12:10:38.594Z -->
...
## todos
```
pkg/dnfinstall/install.go:267  # TODO: implement rpmdb.Writer integration
pkg/dnfinstall/dnfinstall.go:116  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:19  # TODO: s
.github/copilot-instructions.md:21  # TODO: implement rpmdb.Writer integration
.github/copilot-instructions.md:22  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:23  # TODO: s
.github/copilot-instructions.md:24  # TODO: implement rpmdb.Writer integration
.github/copilot-instructions.md:25  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:26  # TODO: s
.github/copilot-instructions.md:27  # TODO: implement rpmdb.Writer integration
.github/copilot-instructions.md:28  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:29  # TODO: s
.github/copilot-instructions.md:30  # TODO: implement rpmdb.Writer integration
.github/copilot-instructions.md:31  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:32  # TODO: s
.github/copilot-instructions.md:33  # TODO: implement rpmdb.Writer integration
.github/copilot-instructions.md:34  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:35  # TODO: s
.github/copilot-instructions.md:36  # TODO: implement ldconfig refresh
.github/copilot-instructions.md:37  # TODO: implement rpmdb.Writer integration
```

## changes (last 10 commits — 7 secondi fa)
```
...
pkg/dnfinstall/dnfinstall_test.go             +TestResolveRootDirLive  +TestResolveRootDirFakeroot  +TestInstallEmptyList  +TestInstallWithOptionsEmptyList
pkg/dnfinstall/caps_test.go                   +TestCapabilityKinds  +TestReadCapListNilInput  +TestExtractCapabilitiesIntegration  +TestExtractCapabilitiesWithRealRPM
pkg/dnfinstall/extract_test.go                +TestExtractRPMInvalidFile  +TestExtractRPMNonexistentFile  +TestExtractRPMNonexistentRootDir  +TestExtractRPMContextCancellation
pkg/dnfinstall/safepath_test.go               +TestSafeRPMPath  +TestSafeRPMPathWithRootSlash  +TestSafeRPMSymlinkTarget  +TestSafeRPMSymlinkTargetWithRootSlash
pkg/dnfinstall/testhelpers_test.go            +buildRPMWithCapabilities  +readRPMHeader
pkg/dnfinstall/verify_test.go                 +TestVerifyRPMSignatureUnsignedWithBypass  +TestVerifyRPMSignatureUnsignedStrict  +TestVerifyRPMSignatureMissingKeyringWithBypass  +TestVerifyRPMSignatureMissingKeyringStrict
pkg/dnfinstall/scriptlet_test.go              +TestFilterScriptletEnv  +TestHasEnvKey  +TestScriptletKindNames  +TestScriptletTagPairs
pkg/dnfinstall/install_test.go                +TestWriteYapdbBasic  +TestWriteYapdbWithCapabilities  +TestWriteYapdbEmptyFiles  +TestWriteYapdbContextCancellation
...
pkg/rpmdb/writer_test.go                      +TestOpenWriterFresh  +TestOpenWriterExisting  +TestOpenWriterPopulated  +TestOpenWriterSchemaMismatch
...
pkg/yapdb/yapdb_test.go                       +TestOpenAndClose  +TestDefaultPath  +TestInsertAndLookup  +TestInsertIdempotent
...
pkg/apkindex/fetch.go                         ~sha1Hex  ~downloadFile  ~loadIndexTarball
...
pkg/aptinstall/aptinstall.go                  ~InstallWithOptions  ~installPackage  ~runMaintainerScript
...
pkg/aptinstall/status.go                      +writeYapdb  +updateDpkgStatusForPackage  ~updateDpkgStatusForPackage  ~readDpkgStatus
pkg/aptrepo/aptrepo.go                        +IsVerificationError  ~Update  ~UpdateWithOptions
pkg/aptrepo/fetch.go                          ~fetchComponentIndex
pkg/aptrepo/release.go                        ~verifyInReleaseOrFallback  ~verifyDetachedOrFallback
pkg/aptrepo/verify.go                         ~verifyDetachedRelease  ~loadKeyringForSource  ~loadDefaultAptKeyring  ~signerName
...
pkg/archive/tar.go                            +is  +extractFromReaderAt  +extractZipIterator  +extract7zIterator
...
pkg/deb822/deb822.go                          +Parse  +appendContinuation
pkg/dnfcache/helpers.go                       ~expandDNFVars
pkg/container/runtime.go                      +Detect  +newCLIRuntime
pkg/dnfcache/install.go                       +DownloadRPM  ~downloadRPM  ~rpmInstall
pkg/dnfinstall/caps.go                        +extractCapabilities  +readCapList
pkg/dnfinstall/install.go                     +downloadAndInstall  +downloadRPM  +installPackage  +writeYapdb
pkg/dnfinstall/extract.go                     +extractRPM  +extractRPMWithHeader  +writeRegularFile  +makeHardlink
pkg/dnfinstall/dnfinstall.go                  +Install  +InstallWithOptions  +InstallFile  +resolveRootDir
pkg/dnfinstall/lock.go                        +that  +acquireLock
pkg/dnfinstall/scriptlet.go                   +filterScriptletEnv  +looksLikeLua  +hasEnvKey  +runScriptlet
pkg/dnfinstall/verify.go                      +verifyRPMSignature  +loadRPMKeyring  +loadRPMKeyringDir  +loadRPMKeyringFile
pkg/dnfinstall/safepath.go                    +safeRPMPath  +safeRPMSymlinkTarget
pkg/download/download.go                      ~Download
pkg/git/git.go                                ~Clone  ~ExtractFromBare
...
pkg/platform/system.go                        +parseOSReleaseFile  ~ParseOSRelease
...
pkg/repo/cross.go                             ~configureCrossArchAndSources  ~refreshCrossAptIndexes  ~restrictLegacySourcesList
pkg/rpmdb/header_writer.go                    +serializeHeader  +serializeHeaderBlob  +toInt32Slice  +dirFromPath
pkg/rpmdb/writer.go                           +OpenWriter
...
cmd/yap/command/install.go                    ~detectPackageType
...
h3 cmd/yap/command/prepare_test.go
```
...
### pkg/dnfinstall/dnfinstall_test.go
```
...
### pkg/dnfinstall/extract_test.go
```
...
### pkg/dnfinstall/safepath_test.go
```
...
### pkg/dnfinstall/testhelpers_test.go
```
...
### pkg/dnfinstall/scriptlet_test.go
```
...
### pkg/dnfinstall/install_test.go
```
...
func installPackage(ctx context.Context, pkg *aptcache.PackageInfo, contents *debContents, tmpDir, rootDir string, opts Options,) → error
...
func writeYapdb(ctx context.Context, pkgName, arch string, controlFields map[string]string, rootDir string, files []string,) → error
func updateDpkgStatusForPackage(ctx context.Context, pkgName, arch, control string, status string, rootDir string, opts Options, files []string,) → error
...
func extractFromReaderAt(ctx context.Context, f *os.File, destination string, patterns []string, buildIter func(io.ReaderAt, int64) → (entryIterator, error), ) erro
...
func (bb) installArchAllDeps(ctx context.Context, archAll, installArgs []string) → error
...
func (bb) installRPMDeps(ctx context.Context, deps []string) → error
...
### pkg/dnfinstall/lock.go
```
func acquireLock(ctx context.Context, rootDir string) → (release func() error, err err
```
...
func hasEnvKey(env []string, key string) → bool
func runScriptlet(ctx context.Context, kind scriptletKind, rpm *rpmutils.Rpm, rootDir string, opts Options,) → error
```
...
func (q) CountPackages(ctx context.Context) → (int64, error)
func (q) GetMaxHnum(ctx context.Context) → (interface
func (q) InsertBasenames(ctx context.Context, arg InsertBasenamesParams) → error
func (q) InsertConflictname(ctx context.Context, arg InsertConflictnameParams) → error
func (q) InsertDirnames(ctx context.Context, arg InsertDirnamesParams) → error
func (q) InsertFiledigests(ctx context.Context, arg InsertFiledigestsParams) → error
func (q) InsertInstalltid(ctx context.Context, arg InsertInstalltidParams) → error
func (q) InsertName(ctx context.Context, arg InsertNameParams) → error
func (q) InsertObsoletename(ctx context.Context, arg InsertObsoletenameParams) → error
func (q) InsertPackage(ctx context.Context, arg InsertPackageParams) → error
func (q) InsertProvidename(ctx context.Context, arg InsertProvidenameParams) → error
```
...
func (w) Close() → error
func (w) Install(ctx context.Context, rpm *rpmutils.Rpm, files []InstalledFile) → error
func (w) tableExists(ctx context.Context, tableName string) → (bool, error)
func (w) initSchema(ctx context.Context) → error
func (w) validateSchema(ctx context.Context) → error
func (w) checkPopulated(ctx context.Context) → error
```
...
INDEX requirenameindex ON Requirename
INDEX conflictnameindex ON Conflictname
INDEX obsoletenameindex ON Obsoletename
INDEX basenamesindex ON Basenames
INDEX dirnamesindex ON Dirnames
INDEX filedigestsindex ON Filedigests
INDEX triggernameindex ON Triggername
INDEX sha1headerindex ON Sha1header
INDEX installtidindex ON Installtid
INDEX sigmd5index ON Sigmd5
```
...
func (q) CapsByPackage(ctx context.Context, packageID int64) → ([]CapsByPackageRow, error)
func (q) CountPackages(ctx context.Context) → (int64, error)
func (q) DeletePackageByNameArch(ctx context.Context, arg DeletePackageByNameArchParams) → error
func (q) FilesByPackage(ctx context.Context, packageID int64) → ([]File, error)
func (q) InsertCap(ctx context.Context, arg InsertCapParams) → error
func (q) InsertFile(ctx context.Context, arg InsertFileParams) → error
func (q) InsertPackage(ctx context.Context, arg InsertPackageParams) → (int64, error)
func (q) IsInstalledByName(ctx context.Context, name string) → (bool, error)
func (q) ListPackages(ctx context.Context) → ([]Package, error)
func (q) LookupPackageByNameArch(ctx context.Context, arg LookupPackageByNameArchParams) → (Package, error)
func (q) LookupProviders(ctx context.Context, name string) → ([]Package, error)
```

### pkg/yapdb/db/models.go
```
type Cap struct
type File struct
type Meta struct
...
### pkg/yapdb/schema.sql
```
TABLE packages
TABLE files
TABLE caps
TABLE meta
INDEX packages_name_arch ON packages
INDEX files_package ON files
INDEX files_path ON files
INDEX caps_name ON caps
INDEX caps_package ON caps
```
...
func (d) initSchema(ctx context.Context) → error
func (d) Insert(ctx context.Context, p *Package) → error
func (d) Remove(ctx context.Context, name, arch string) → error
func (d) IsInstalled(ctx context.Context, name string) → (bool, error)
func (d) ProvidersOf(ctx context.Context, capName string) → ([]string, error)
func (d) List(ctx context.Context) → ([]Package, error)
func (d) LookupByName(ctx context.Context, name, arch string) → (*Package, error)
func (d) Close() → error
```
