...
<!-- Updated: 2026-05-17T16:22:44.461Z -->
...
pkg/project/utils_test.go                     +TestGetRuntimeDepsWithSkipFilter  ~TestGetRuntimeDepsDeduplication
pkg/project/project_test.go                   +TestMultipleProjectWithSkipFlag
...
pkg/aptcache/aptcache.go                      +Reload  ~Load  ~loadFromDisk
pkg/builders/common/cross.go                  +aptGetDownload  +ValidateTargetArch
...
pkg/gensum/gensum.go                          +unquoteShellValue  +suitable  +extractScalarVars  +UpdateChecksums
pkg/logger/logger.go                          +visibleLen  +termWidth  +avoids  +getHandler
pkg/repo/cross.go                             ~SetupCrossAPT
pkg/shell/exec.go                             +extractErrorLines  ~formatDecoratedLine  ~logScriptContent  ~RunScriptInFakeroot
cmd/yap/command/build.go                      ~InitializeBuildDescriptions  ~init
