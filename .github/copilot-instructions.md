...
<!-- Updated: 2026-05-17T12:31:51.673Z -->
...
## changes (last 10 commits — 3 secondi fa)
```
...
cmd/yap/command/root.go                       +ParseLanguageFlag  ~Execute  ~updateSubCommandDescriptions  ~init
cmd/yap/command/zap.go                        ~init
cmd/yap/command/version.go                    +printVersion  ~getCurrentTime
.github/copilot-instructions.md               +validateCompression  +resolveSigning  +logStructuredError  +InitializeBuildDescriptions
```
