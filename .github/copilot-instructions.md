...
<!-- Updated: 2026-05-12T19:32:56.559Z -->
...
pkg/builders/common/extract_test.go           +TestExtractToRoot  +TestExtractToRoot_UnsupportedFormat  ~TestExtractToSysroot  ~TestExtractToSysroot_UnsupportedFormat
pkg/builders/common/toolchains_test.go        ~TestGetExecutableName
pkg/builders/common/skip_validation_test.go   +doesn  ~TestSkipToolchainValidationFlag
pkg/builders/common/toolchains_i18n_test.go   ~TestValidateToolchainI18nErrorMessages  ~TestValidateToolchainI18nDistroSpecificNotes  ~TestValidateToolchainI18nInstallationCommands
pkg/builders/common/interface_test.go         ~TestSetupCrossCompilationEnvironment  ~TestCrossCompilationToolchainMapping
pkg/builders/common/toolchains_methods_test.go ~will  ~TestCrossToolchainMapCompleteness  ~TestCrossToolchainPackageValidation  ~TestRiscv64Support
pkg/builders/common/toolchains_validation_test.go ~TestCrossToolchainValidateMissingGPlus  ~TestCrossToolchainValidateMissingBinutils
pkg/parser/parser_test.go                     +TestParseFile_SplitPackage  +is  ~TestParserEnhancementIntegration
pkg/pkgbuild/pkgbuild_test.go                 +TestIsSplitPackage_Single  +TestIsSplitPackage_Split  +TestEffectivePkgBase_WithPkgBase  +TestEffectivePkgBase_FallbackToPkgName
pkg/shell/exec_test.go                        +TestRunScriptInFakeroot  +TestRunScriptInFakerootOwnership  +TestRunScriptInFakerootEmpty  +TestRunScriptInFakerootInvalidSyntax
pkg/archive/tar.go                            ~CreateTarZst  ~ExtractFiltered  ~Extract
pkg/builder/builder.go                        +for  +map  +exists  +found
pkg/builders/common/extract.go                +cleanupMetadataFiles  +extractDEB  ~countFilesAndSize  ~extractDEB
pkg/builders/common/toolchains.go             ~GetCrossToolchain  ~ValidateToolchain
pkg/pkgbuild/pkgbuild.go                      +and  +body  +so  ~isIncludeDir
pkg/project/project.go                        ~setupCopyOptions
pkg/shell/fakeroot.go                         +applyFakeroot
pkg/shell/exec.go                             +fakerootExecHandler  +interpretCmdError  +fakerootExecEnv  +RunScriptInFakeroot
.github/copilot-instructions.md               +initCommandDescriptions  +InitializePrepareDescriptions  +init  +validateCompression
```
